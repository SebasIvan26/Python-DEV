...
def generateDiff(path1, path2):
    ...
    dest = r'/Users/sebastienstvil/Documents/Python/Python-DEV/Beta Custom - GIT pulls copy/Base-master/Testing/pdf_Tests/diff.html' if system == 'Darwin' else 'Put file path here'
