...
class Window(QWidget):
    ...
    def playGame(self):
        ...
        if self.rndComputer == 1:
            self.imageComputer.setPixmap(QPixmap("GA Lab/GUI/RPS Images/game.png"))
        elif self.rndComputer == 2:
            self.imageComputer.setPixmap(QPixmap("GA Lab/GUI/RPS Images/paper.png"))
        else:
            self.imageComputer.setPixmap(QPixmap("GA Lab/GUI/RPS Images/scissors.png"))


        if self.rndPlayer == 1:
            self.imagePlayer.setPixmap(QPixmap("/Users/sebastienstvil/Documents/Python/Python-DEV/GA Lab/GUI/RPS Images/game.png"))

        elif self.rndPlayer == 2:
            self.imagePlayer.setPixmap(QPixmap("GA Lab/GUI/RPS Images/paper.png"))
        else:
            self.imagePlayer.setPixmap(QPixmap("GA Lab/GUI/RPS Images/scissors.png"))
