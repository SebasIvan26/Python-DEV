...
>####Another approach to the above is by accessing a database containing all the expected information. On one end, the data would not be a live stream however the complexity of implementation can be subtantially lower. 
